...
![records](https://img.shields.io/badge/dynamic/json?label=records&color=blue&query=$.count&url=https://raw.githubusercontent.com/kishiyamat/mishearing-corpus/feature/add-record-batch/badges/records.json)
